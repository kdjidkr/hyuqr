export default async function handler(req, res) {
    ...
    try {
        const fetchRes = await fetch('https://lib.hanyang.ac.kr/pyxis-api/2/api/seat-discharges', {
            method: 'POST',
            headers: {
        ...
        console.error('Seat Discharge API error:', err);
